...
const WorkerSelector: React.FC<MapsProps> = ({pickupCoordinates,dropOffCoordinates}) => {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://api.mapbox.com/directions/v5/mapbox/driving/${[pickupCoordinates][0]},${[pickupCoordinates][1]};${[dropOffCoordinates][0]},${[dropOffCoordinates][1]}?access_token=pk.eyJ1Ijoib21hcmFzaHplaW5ob205OCIsImEiOiJjbDRrMXY5c3MwN3ZpM2NxcHp3ZGVmN3ZyIn0.3Ziuh7Utama_wz_4s8qh2g`
    );
